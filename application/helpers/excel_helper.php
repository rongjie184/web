...
class Spreadsheet_Excel_Reader {
	...
	// =========================================
	function dump($row_numbers=false,$col_letters=false,$tableid='excel',$sheet=0,$table_class='excel') {

		$out = "<table class=\"$table_class\" id=\"$tableid\" cellspacing=0>";
		if ($col_letters) {
			$out .= "<thead>\n\t<tr>";
			if ($row_numbers) {
				$out .= "\n\t\t<th>&nbsp</th>";
	...
	function mydump($row_numbers=false,$col_letters=false,$sheet=0,$table_class='excel') {
