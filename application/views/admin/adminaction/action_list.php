...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 权限列表</title>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                <td colspan=2><input type="text" name='search' value='<?=$search?>' class="form-control" placeholder="搜索 名称 / 代码"></td>
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td><a class='btn btn-warning btn-sm' href='/index.php/admin/adminaction/action_edit?action_id=<?=$value["id"]?>' >编辑</a></td>
                  </tr>
                <?php
                }}else{
                  ?>
