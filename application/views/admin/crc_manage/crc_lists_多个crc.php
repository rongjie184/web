              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<td><select id='items_id' name='items_id' class="form-control select2" style="width: 100%;" onchange="changeDatas()">
				 ...
				 <td><select id='inits_id' name='inits_id' class="form-control select2" style="width: 100%;">
                        ...
                        <td colspan=3><?php if($check){?> <a class='btn btn-primary btn-sm' href='javascript:void(0);' onclick="return check()">人员管理</a> <a class='btn btn-info btn-sm' href='javascript:void(0);' onclick="return out()">退出</a> <?php }else{?> 
						<a class='btn btn-primary btn-sm' href='javascript:void(0);' onclick="return check()">人员管理</a>  
						<a class='btn btn-info btn-sm' href='javascript:void(0);' onclick="return out()">退出</a>  <a class='btn btn-success btn-sm' href='javascript:void(0);' onclick="return enter()">加入</a><?php }?> </td> 
                </tr>
                <tr>
