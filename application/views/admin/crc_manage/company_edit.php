...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 编辑CRC所属公司</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                <div class="form-group">
                  <label for="name" class="col-sm-2 control-label">所属公司名称</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="cname" name='cname' value='<?=$company['cname']?>' placeholder="请输入所属公司名称">
                  </div>
                </div>
