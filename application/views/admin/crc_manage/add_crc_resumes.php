			...
			<input type="hidden" name="uid" value="<?=$uid?>" id="uid">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="jxname" name='jxname' value="">
                  </div>
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-10">
				   ...
				   <span style="position: relative; z-index: 9999;"> <input type="text" class="datepicker" id="start_time"  name='start_time' value="">-<input type="text" class="datepicker" id="end_time"  name='end_time' value=""></span>
                  </div>
				...
				?>
				 <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="dename"  name='dename' value="" >
                  </div>
