...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加CRC组别</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                <div class="form-group">
                  <label for="name" class="col-sm-2 control-label">CRC组别名称</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="gname" name='gname' placeholder="请输入组别名称">
                  </div>
                </div>
     ...
     fields: {
        gname:{
          validators: {
			...
			remote:{
              url: '/index.php/admin/crc_manage/group_name_check',
              type: 'post',  
              delay:800,
