...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 资讯详情预览</title>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">资讯详情预览</h3>
            </div>
            <!-- /.box-header -->
       
              <div class="box-body col-sm-offset-1 ">
              <h1><?=$news['title']?></h1>
               <h4>作者：<?=$news['author']?> <small><?=date('Y-m-d H:i:s',$news['add_time'])?></small></h3>
               <p><?=$news['describe']?></p>
             </div>
              <!-- /.box-body -->
              <div class="box-footer">
                <div class="form-group">
                  <div class="col-sm-offset-3 col-sm-2">
					<a class="btn btn-default btn-block" href="javascript:history.back(-1)" role="button">返回</a>
                  </div>
                </div>
              </div>
