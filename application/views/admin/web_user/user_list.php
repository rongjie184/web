                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td>
					 ...
					 <a class='btn btn-info btn-sm' href='/index.php/admin/web_user/wuser_edit?uid=<?=$value["uid"]?>' >修改</a>


                      <?php 
                      if($value['role_id']!=3){
                      if($value['state']==1){?>
                      <a class='btn btn-success btn-sm' href='/index.php/admin/webaction/change_wuser_status?state=1&uid=<?=$value["uid"]?>' >解除</a>
                      <?php }else{ ?>
                      <a class='btn btn-danger btn-sm' href='/index.php/admin/webaction/change_wuser_status?state=0&uid=<?=$value["uid"]?>' >限制</a>  
                      <?php } }?>
                    </td>
                  </tr>
                <?php
