...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 数据修订列表</title>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
                  foreach($revise as $value){
                    //print_r($value);
                  ?>
                  <tr>
                    <td><?=$value['instname']?></td>
                    <td>
                      <?php foreach($value['diff'] as $key =>$val){ ?>
                      <?=$key.':'.$val ?>
                      <?php }?>
                    </td>
                    <td><?=date('Y-m-d',$value['add_time'])?></td>
                    <td>
            
            <a class='btn btn-success btn-sm' href='/index.php/admin/institution/detail_datarevise?id=<?=$value["did"]?>' >查看</a> 
