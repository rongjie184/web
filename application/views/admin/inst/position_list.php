...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 中心职位列表</title>
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td>
					 ...
					 <a class='btn btn-info btn-sm' href='/index.php/admin/institution/edit_position?id=<?=$value["id"]?>' >修改</a>
           <?php if($value['status']==1){ ?>
           <a class='btn btn-danger btn-sm' href='/index.php/admin/institution/change_status?&table=position&state=0&id=<?=$value["id"]?>'>限制</a>
             <?php }else{ ?>  
           <a class='btn btn-warning btn-sm'' href='/index.php/admin/institution/change_status?&table=position&state=1&id=<?=$value["id"]?>'>解除</a>  
             <?php } ?>     
                    </td>
                  </tr>
                <?php
