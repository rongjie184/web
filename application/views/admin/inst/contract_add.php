...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加合同</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm' enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                   <span type="text" class="form-control" id="address" name='address' placeholder="地址"><?=$inst['instname']?></span>
                  </div>
                </div>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                   <select id='linkman' name='linkman' class="form-control select2" style="width: 100%;">
                      ...
                      ?>
                      <option value='<?=$value['id']?>' <?=$value['id']==$member['id']?'selected="selected"':''?>><?=$value['name']?></option>
                      <?php
                      }
                      ?>
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2" name="budui">
                    <label class="radio-inline">
                      <input type="radio" value="1" name="tel">是
                    </label>
                    <label class="radio-inline">
                      <input type="radio" value="0" name="tel" >否
                    </label>
                  </div>
                </div> 
                ...
                <div class="form-group">
                  ...
                  <input type="button" value="取消" id="reset1" style="display:none;">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2" name="pizhun">
                    <label class="radio-inline">
                      <input type="radio" value="1" name="is_contract">是
                    </label>
                    <label class="radio-inline">
                      <input type="radio" value="0" name="is_contract" >否
                    </label>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2" name="pizhun">
                    <label class="radio-inline">
                      <input type="radio" value="1" name="is_answer">是
                    </label>
                    <label class="radio-inline">
                      <input type="radio" value="0" name="is_answer" >否
                    </label>
                  </div>
                </div>
...
$(document).ready(function() {
  $("#tel_contract").change(function(){

    if(document.getElementById("tel_contract").value!=""){
      document.getElementById("reset1").style="display:block";               
    }
  })
    $("#reset1").click(function(){
      document.getElementById("tel_contract").value=""; 
