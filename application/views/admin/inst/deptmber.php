...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 科室人员详情</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <span type="text" class="form-control"  placeholder="" value="<?=$dept['name']?>"><?=$dept?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">人员姓名</label>
                    <div class="col-sm-2">
                      <span type="text" class="form-control" id="uid" name='uid' value="<?=$member['id']?>"><?=$deptmember['name']?></span>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <span type="text" class="form-control" id="position"  name='position' placeholder="请输入职位" value="<?=$member['position']?>" ><control?=$deptmember['position']?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <span type="text" class="form-control" id="professor"  name='professor' placeholder="请输入职位" value="<?=$member['professor']?>" ><?=$deptmember['professor']?></span>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-2" name="prior">
                    <label class="form-control">
                      <span type="texy" value="pi" name="identity"><?=$deptmember['identity']?></span>
                    </label>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <span type="text" class="form-control" id="phone" name='phone' ><?=$deptmember['phone']?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <span type="text" class="form-control" id="email" name='email' ><?=$deptmember['email']?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <span type="text" class="form-control" id="academy" name='academy' ><?=$deptmember['academy']?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <span type="text" class="form-control" id="graduation_time"  name='graduation_time' ><?=$deptmember['graduation_time']?date('Y-m-d',$deptmember['graduation_time']):''?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <span type="text" class="form-control" id="major" name='major' ><?=$deptmember['major']?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2" name="prior">
                    <label class="form-control">
                      <span type="radio" value="1" name="qualification"><?=xueli($deptmember['qualification'])?></span>
                    </label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <textarea type="text" class="form-control" id="character" name='character'><?=$deptmember['character']?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <textarea type="text" class="form-control" id="interest" name='interest'><?=$deptmember['interest']?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <textarea type="text" class="form-control" id="advantage" name='advantage'><?=$deptmember['advantage']?></textarea>
                  </div>
                </div>
              ...
              <div class="box-footer">
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-4">
                      <a class="btn btn-default" href='/index.php/admin/institution/detail_dept?id=<?=$deptmember["dept_id"]?>' >返回</a> 
                  </div>
                </div>
              </div>
