...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 查看合同</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                   <span type="text" class="radio-inline" id="address" name='address' placeholder="地址"><?=$inst['instname']?></span>
                  </div>
                </div>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <span type="text" class="radio-inline" id="address" name='address' placeholder="地址" >
                      <?=$contract['name']?>
                    </span>
                  </div>
                </div>
                <div class="form-group">
                  <label for="appid" class="col-sm-2 control-label">合同负责人电话</label>
                  <div class="col-sm-2">
                    <span type="text" class="radio-inline" id="address" name='address' placeholder="地址" >
                      <?=$contract['phone']?>
                    </span>
                ...
                <div class="form-group">
                  <label for="appid" class="col-sm-2 control-label">合同负责人邮箱</label>
                  <div class="col-sm-2">
                    <span type="text" class="radio-inline" id="address" name='address' placeholder="地址" >
                      <?=$contract['email']?>
                    </span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                   <span type="text" class="radio-inline" id="address" name='address' placeholder="地址" ><?=$contract['address']?></span>
                  </div>
                </div>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2" name="budui">
                    <span type="text" class="radio-inline" id="contract_type" name='contract_type'><?=$contract['is_templet']=='1'?'是':'否'?></span>
                  </div>
                </div> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <span  class="radio-inline" id="procedure" name='procedure'  >
                      <a href="<?=$contract['tel_contract']?>">点击查看</a>
                    </span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <span  class="radio-inline" id="procedure" name='procedure'  >
                      <a href="<?=$contract['process']?>">点击查看</a>
                    </span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2" name="pizhun">
                    <span type="text" class="radio-inline" id="contract_type" name='contract_type'><?=$contract['is_contract']=='1'?'是':'否'?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2" name="pizhun">
                    <span type="text" class="radio-inline" id="contract_type" name='contract_type'><?=$contract['is_answer']=='1'?'是':'否'?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                     <span type="text" class="radio-inline" id="contract_type" name='contract_type'><?=$contract['contract_type']?></span>
                  </div>
                </div>
