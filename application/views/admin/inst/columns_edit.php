            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="appid" class="col-sm-2 control-label">字段名称</label>
                  <input type="hidden"  id="id"  name='id' value="<?=$columns['id']?>">
                  <div class="col-sm-3">
                   <span> <input type="text" class="form-control" id="cname"  name='cname' value="<?=$columns['cname']?>"></span>
                  </div>
                </div>   
