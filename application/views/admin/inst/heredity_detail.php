...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 遗传办详情</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                   <span type="text" class="radio-inline" id="address" name='address'><?=$inst['instname']?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                   <span type="text" class="radio-inline" id="address" name='address' ><?=$heredity['address']?></span>
                  </div>
                </div>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2" name="budui">
                    <span type="text" class="radio-inline" id="address" name='address' ><?=$heredity['is_lead']==1?'是':'否'?></span>
                  </div>
                </div> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-1">
                     <span type="text" class="radio-inline" id="cost" name='cost' value=""><?=$heredity['cost']?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-1">
                     <span type="text" class="radio-inline" id="number" name='number' placeholder="次数" value=""><?=$heredity['number']?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <span  class="radio-inline" id="procedure" name='procedure'  >
                      <a href="<?=$heredity['procedure']?>">点击查看</a>
                    </span>
                  </div>
                </div>
