...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 修改关中心</title>
          ...
          <div class="box box-primary">
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm' enctype="multipart/form-data">
              <div class="box-body">
                ...
                <input type="hidden" class="form-control" id="id" name="id" value="<?=$closeinst['id'] ?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <span  class="radio-inline" id="address" name='address' ><a href="<?=$closeinst['procedure']?>">点击查看原文档</a></span>
                  </div>
                </div>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                   <textarea type="text" class="form-control" id="require" name='require' placeholder="要求"><?=$closeinst['require']?></textarea>
                  </div>
                </div>  
