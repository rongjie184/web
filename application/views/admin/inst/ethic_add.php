...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加伦理</title>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    ...
                    <input type="hidden" class="datepicker" id="instid"  name='instid' value="<?=$inst['id'] ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                   <span> <input type="text" class="datepicker" id="jiedai_time"  name='jiedai_time' style="width:180px"></span>
                  </div>
                </div>   
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <textarea type="text" class="form-control" id="doc_require" name='doc_require' placeholder="提交文件要求"></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2" name="budui">
                    <label class="radio-inline">
                      <input type="radio" value="1" name="approval">是
                    </label>
                    <label class="radio-inline">
                      <input type="radio" value="0" name="approval" >否
                    </label>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-1">
                    <input type="text" class="form-control" id="rate" name='rate' placeholder="频率">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" class="form-control" id="meeting" name='meeting' placeholder="上会">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" class="form-control" id="quicktrial" name='quicktrial' placeholder="快审">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                   <span> <input type="text" class="datepicker" id="ethic_time"  name='ethic_time' style="width:180px"></span>
                  </div>
                </div>  
