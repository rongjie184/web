...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 修改遗传办</title>
          ...
          <div class="box box-primary">
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm' enctype="multipart/form-data">
              <div class="box-body">
                ...
                <input type="hidden" class="form-control" id="hid" name="hid" value="<?=$heredity['id'] ?>" >
                <div class="form-group">
                  <label for="appid" class="col-sm-2 control-label">遗传办地址</label>
                  <div class="col-sm-2">
                   <input type="text" class="form-control" id="address" name='address' placeholder="地址" value="<?=$heredity['address'] ?>">
                  </div>
                </div>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2" name="budui">
                    <label class="radio-inline">
                      <input type="radio" value="1" name="is_lead" <?=$heredity['is_lead']=='1'?'checked=checked':'' ?>">是
                    </label>
                    <label class="radio-inline">
                      <input type="radio" value="0" name="is_lead" <?=$heredity['is_lead']=='0'?'checked=checked':'' ?>">否
                    </label>
                  </div>
                </div> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-1">
                     <input type="text" class="form-control" id="cost" name='cost' placeholder="费用" value="<?=$heredity['cost'] ?>">
                  </div>
                </div>

                <div class="form-group">
                  <label for="c" class="col-sm-2 control-label">可牵头次数</label>
                  <div class="col-sm-1">
                     <input type="text" class="form-control" id="number" name='number' placeholder="次数" value="<?=$heredity['number'] ?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <span  class="radio-inline" id="address" name='address' ><a href="<?=$heredity['procedure']?>">点击查看原文档</a></span>
                  </div>
                </div> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                     <textarea type="text" class="form-control" id="remarks" name='remarks'><?=$heredity['remarks'] ?></textarea>
                  </div>
                </div>
