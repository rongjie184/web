...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 修改机构职位</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="uname" class="col-sm-2 control-label">所属中心</label>
                  <div class="col-sm-2">
                   <span type="text" class="form-control" id="name" name='instName'><?=$position['instname']?></span>
                   <input type="hidden" id="instid" name='instId' value="<?=$position['instId']?>">
                  </div>
