...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加关中心</title>
          ...
          <div class="box box-primary">
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm' enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="appid" class="col-sm-2 control-label">关中心特殊要求</label>
                  <div class="col-sm-3">
                   <textarea type="text" class="form-control" id="require" name='require' placeholder="要求"></textarea>
                  </div>
                </div>  
