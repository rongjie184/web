          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                <td colspan=2><input type="text" name='search' value='<?=$search?>' class="form-control" placeholder="搜索 机构名称"></td>
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span class="label label-default">通过审核</span>
                      <?php }else if($value['status']==2){?>
                      <span class="label label-success">拒绝通过</span>
                      <?php }?>
                    </td>
                    <td>
            
            <a class='btn btn-danger btn-sm' href='/index.php/admin/institution/detail_institution?id=<?=$value["id"]?>' >查看</a> 
					 <a class='btn btn-info btn-sm' href='/index.php/admin/institution/edit_institution?id=<?=$value["id"]?>' >修改</a>
           <a class='btn btn-success btn-sm' onclick="del('/index.php/admin/institution/change_inst_status?state=1&id=<?=$value["id"]?>')">删除</a>
                      <?php 
                      if($value['role_id']!=2){
                      if($value['state']==1){?>
