...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加工作内容</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="wname" name='wname' placeholder="请输入工作内容名称">
                  </div>
                </div>
...
$(document).ready(function() {
   $('#iForm').formValidation({
     ...
     fields: {
        wname:{
          validators: {
            notEmpty: {message: '工作内容名称不可为空'},
			remote:{
              url: '/index.php/admin/work_manage/wname_check',
              type: 'post',  
              delay:800,
