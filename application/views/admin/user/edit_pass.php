...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 修改密码</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="password" class="form-control" id="newpass"  name='newpass' placeholder="请输入登录密码" pattern="^\w{6,20}$" data-fv-regexp-message="密码需为长度6-20位的数字或字母" >
                  </div>
                </div>
                <div class="form-group">
     ...
     fields: {
                  ...
                  repatpass:{
                    validators:{
                      ...
                      identical:{field:'newpass',message:'两次密码输入不一致'}
                    }
                  }
              }
   })
