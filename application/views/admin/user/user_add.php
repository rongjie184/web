...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加用户</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
			  ...
			  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="uname" name='uname' placeholder="请输入用户姓名">
                  </div>
                ...
                <div class="form-group">
                  <label for="passwd" class="col-sm-2 control-label">登录密码</label>

                  <div class="col-sm-3">
                    <input type="password" class="form-control" id="passwd"  name='passwd' placeholder="请输入登录密码" pattern="^\w{6,20}$" data-fv-regexp-message="密码需为长度6-20位的数字或字母" >
                  </div>
                </div>
                <div class="form-group">
                  <label for="repatpass" class="col-sm-2 control-label">重复密码</label>

                  <div class="col-sm-3">
                    <input type="password" class="form-control" id="repatpass" name='repatpass' placeholder="请重复登录密码">
                  </div>
                </div>
