...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 项目审核列表</title>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				<tr> 
				<td colspan="7"><a class='btn btn-warning btn-sm' href='javascript:pass();' >审核通过</a></td>
                ...
                <?php
                  ...
                  <tr>
				   <td><input type="checkbox" value="<?=$value['id']?>" name="ids[]"></td>
                    ...
                    <td>					
					<a class='btn btn-info btn-sm' href='/index.php/admin/item_manage/item_edit?view=check&id=<?=$value["id"]?>' >修改</a>
...
function pass(){
	morecheck();
	if(confirm("确定要通过审核吗？")){
		document.dbform.action="/index.php/admin/item_manage/item_check_ok";
		dbform.submit();
	}
