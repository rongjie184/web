...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加项目</title>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="datepicker" id="start_time" name='start_time'>
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <input type="radio" value="1" name="is_linkstart">联斯达
                    </label>
                    <label class="radio-inline">
                      <input type="radio" value="0" name="is_linkstart">其它SMO公司
                    </label>
                  </div>
                </div>  
                ...
                <div class="form-group" id="xmbh">
                  ...
                  <div class="col-sm-2">
                   <span> <input type="text" id="item_number"  name='item_number' style="width:180px" placeholder="请以LST-开头，32位" ></span>
                  </div>
                </div>   
				 <div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-4">
				  <span><input type="text" class="form-control" id="inis_num" name='inis_num' ></span>
				  </div>
				  </div>
				  <div class="form-group">
				...
				<div class="form-group" id="yaopin">
...
<!--
				 <div class="form-group">
                  ...
                  <?php foreach($methods as $key=>$val){?>
				   <label class="radio-inline"><input type="radio" name="methods_id" id="methods_id<?=$key?>" value="<?=$key?>"><?=$val?></label>
...
-->
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="indications" name='indications' placeholder="适应症">
                  </div>
                </div>
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="plan_num" name='plan_num'>
                  </div>
                </div>
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="real_num" name='real_num'>
                  </div>
                </div>
