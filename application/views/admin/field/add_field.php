...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加领域</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="name" name='name' placeholder="请输入领域名称">
                  </div>
                </div>
                <div class="form-group">
     ...
     fields: {
        name:{
          validators: {
			...
			remote:{
              url: '/index.php/admin/field/field_name_check',
              type: 'post',  
              delay:800,
