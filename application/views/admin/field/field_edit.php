...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 编辑领域</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                <div class="form-group">
                  <label for="name" class="col-sm-2 control-label">领域名称</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="name" name='name' value='<?=$field['name']?>' placeholder="请输入领域名称">
                  </div>
                </div>
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="desc" name='desc' value='<?=$field['desc']?>'placeholder="请输入描述">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    ...
                    <select class="form-control" id="status" name='status'>
                        <option <?=$field['status']==1?'selected':''?> value=1>正常</option>
                        <option <?=$field['status']==0?'selected':''?> value=0>关闭</option>
                    </select>
                  </div>
                </div>
              ...
              <div class="box-footer">
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-4">
                    <input type="hidden" name="id" value='<?=$field['id']?>' id="id">
...
$(document).ready(function() {
   $('#iForm').formValidation({
     ...
     fields: {
        name:{
          validators: {
            notEmpty: {message: '领域名称不可为空'},
			 remote:{
              url: '/index.php/admin/field/field_names_check',
              type: 'post',  
              delay:800,
			  data:{
