...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加脚本</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="name"  name='name' placeholder="请输入脚本名称">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <label class="radio-inline">
                      <input type="radio" name="type" id="type1" value="1"> 固定时间
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="type" id="type2" value="2"> 频率
                    </label>        
                  </div>
                </div>  
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="file_name" name='file_name' placeholder="请输入脚本文件名">
                  </div>
                </div>
                <div class="form-group">
                  <label for="content" class="col-sm-2 control-label">备注</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="content" name='content' placeholder="请输入脚本备注">
                  </div>
                </div>
