...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 修改角色</title>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
			...
			<input type="hidden" name="id" value="<?=$sinfo['id']?>" id="id">
              <input type="password" style="display: none;">
              <div class="box-body">
                <div class="form-group">
                  <label for="uname" class="col-sm-2 control-label">角色名称</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="rolename" name='rolename' value="<?=$sinfo['rolename']?>">
                  </div>
     ...
     fields: {
        ...
        rolename:{
           validators: {
            ...
            remote:{
              url: '/index.php/admin/web_role/role_names_check',
              type: 'post',  
              delay:800,
				   data:{
