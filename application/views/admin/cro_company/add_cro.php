...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加CRO公司</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="crname" name='crname' placeholder="请输入CRO公司名称">
                  </div>
                </div>
				 <div class="form-group">
                  <label for="name" class="col-sm-2 control-label">PM</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="pm" name='pm' placeholder="请输入PM">
                  </div>
                </div>
				 <div class="form-group">
                  <label for="name" class="col-sm-2 control-label">PM电话</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="pm_phone" name='pm_phone' placeholder="PM电话">
                  </div>
                </div>
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="cra_name" name='cra_name' placeholder="请输入CRA姓名">
                  </div>
                </div>
				 <div class="form-group">
                  <label for="name" class="col-sm-2 control-label">CRA电话</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="cra_phone" name='cra_phone' placeholder="CRA电话">
                  </div>
                </div>
     ...
     fields: {
        crname:{
          validators: {
			...
			remote:{
              url: '/index.php/admin/cro_company/cro_name_check',
              type: 'post',  
              delay:800,
