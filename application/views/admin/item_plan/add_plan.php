...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加项目进度</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="name" name='name' placeholder="请输入项目进度名称">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="order_num" name='order_num' placeholder="请输入序号">
                  </div>
                </div>
...
$(document).ready(function() {
   $('#iForm').formValidation({
     ...
     fields: {
        name:{
          validators: {
            notEmpty: {message: '项目进度名称不可为空'},
			remote:{
              url: '/index.php/admin/item_plan/pname_check',
              type: 'post',  
              delay:800,
