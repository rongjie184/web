...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 编辑SMO公司</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                <div class="form-group">
                  <label for="name" class="col-sm-2 control-label">SMO公司名称</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="cname" name='cname' value='<?=$company['cname']?>' placeholder="请输入SMO公司名称">
                  </div>
                </div>
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="pm" name='pm' value='<?=$company['pm']?>' placeholder="请输入PM">
                  </div>
                </div>
				 <div class="form-group">
                  <label for="name" class="col-sm-2 control-label">PM电话</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="pm_phone" name='pm_phone' value='<?=$company['pm_phone']?>' placeholder="PM电话">
                  </div>
                </div>
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="desc" name='desc' value='<?=$company['desc']?>'placeholder="请输入描述">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    ...
                    <select class="form-control" id="status" name='status'>
                        <option <?=$company['status']==1?'selected':''?> value=1>正常</option>
                        <option <?=$company['status']==0?'selected':''?> value=0>关闭</option>
                    </select>
                  </div>
                </div>
...
$(document).ready(function() {
   $('#iForm').formValidation({
     ...
     fields: {
        cname:{
          validators: {
            notEmpty: {message: 'SMO公司名称不可为空'},
			 remote:{
              url: '/index.php/admin/company/company_names_check',
              type: 'post',  
              delay:800,
			  data:{
