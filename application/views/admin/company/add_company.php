...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加SMO公司</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="cname" name='cname' placeholder="请输入SMO公司名称">
                  </div>
                </div>
     ...
     fields: {
        cname:{
          validators: {
			...
			remote:{
              url: '/index.php/admin/company/company_name_check',
              type: 'post',  
              delay:800,
