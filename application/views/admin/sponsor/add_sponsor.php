...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 添加申办方公司</title>
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm'>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="sname" name='sname' placeholder="请输入申办方公司名称">
                  </div>
                </div>
     ...
     fields: {
        sname:{
          validators: {
			...
			remote:{
              url: '/index.php/admin/sponsor/sponsor_name_check',
              type: 'post',  
              delay:800,
