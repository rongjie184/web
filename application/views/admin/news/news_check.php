...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 资讯审核列表</title>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				<tr><td colspan=6>   <a class='btn btn-warning btn-sm' href='javascript:pass();' >通过</a></td></tr>
                <tr>
                ...
                <?php
				  ...
				  <td><input type="checkbox" value="<?=$value['id']?>" name="ids[]"></td>
                    ...
                    <?=$value['ftitle']?>
					 ...
					 <td>
                    <input type="image" src="<?=$value['titpic']?>" width="20px" height="20px">
                    </td>
					<td><?=$value['author']?></td>
                    <td>
                    ...
                    <td>
                      ...
                      <a class='btn btn-warning btn-sm' href='/index.php/admin/news/change_status?status=0&id=<?=$value["id"]?>' >通过</a> 
...
function pass(){
	morecheck();
	if(confirm("确定要通过审核吗？")){
		document.dbform.action="/index.php/admin/news/pass";
		dbform.submit();
	}
