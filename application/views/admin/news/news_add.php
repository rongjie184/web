...
<head>
  ...
  <title><?=$this->config->item('web_title')?> | 上传资讯</title>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form class="form-horizontal" method="post" action='<?=$this->form_action?>' id='iForm' enctype="multipart/form-data">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="ftitle" name='ftitle' placeholder="请输入资讯副标题">
                  </div>
                </div>
           ...
           <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="order_num" name='order_num' placeholder="请输入显示顺序">
                  </div>
                </div>
				 ...
				 <div class="form-group">
                  <label for="titpic" class="col-sm-2 control-label">标题图片</label>
                  <div class="col-sm-4">
				  <span class="help-block"></span>
					 <input type="file" name="titpic" class="file" id="titpic" size="28" >
                  </div>
